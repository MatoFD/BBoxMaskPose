...
train_dataset = dict(
    ...
    datasets=[
        dict(
            type='mmpose_bboxMasPose.OneHand10KDataset',
            data_root=data_root,
            data_mode=data_mode,
        ...
        dict(
            type='mmpose_bboxMasPose.FreiHandDataset',
            data_root=data_root,
            data_mode=data_mode,
            pipeline=train_pipeline,
        ...
        dict(
            type='mmpose_bboxMasPose.Rhd2DDataset',
            data_root=data_root,
            data_mode=data_mode,
            pipeline=train_pipeline,
        ...
        dict(
            type='mmpose_bboxMasPose.HalpeHandDataset',
            data_root=data_root,
            data_mode=data_mode,
            pipeline=train_pipeline,
