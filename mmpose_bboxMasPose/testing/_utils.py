...
from mmpose_bboxMasPose.structures import MultilevelPixelData, PoseDataSample
...
def get_repo_dir():
    ...
    try:
        # Assume the function in invoked is the source mmpose_bboxMasPose repo
        repo_dir = osp.dirname(osp.dirname(osp.dirname(__file__)))
    except NameError:
        # For IPython development when __file__ is not defined
        import mmpose_bboxMasPose
        repo_dir = osp.dirname(osp.dirname(mmpose_bboxMasPose.__file__))
