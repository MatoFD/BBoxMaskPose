...
from mmpose_bboxMasPose.models.builder import build_pose_estimator
from mmpose_bboxMasPose.structures import PoseDataSample
from mmpose_bboxMasPose.structures.bbox import bbox_xywh2xyxy
...
def dataset_meta_from_config(config: Config,
    ...
    Returns:
        ...
        ``mmpose_bboxMasPose.datasets.datasets.utils.parse_pose_metainfo`` for details.
    ...
    try:
        ...
        if 'metainfo' in dataset_cfg:
            ...
            import mmpose_bboxMasPose.datasets.datasets  # noqa: F401, F403
...
def init_model(config: Union[str, Path, Config],
    ...
    scope = config.get('default_scope', 'mmpose_bboxMasPose')
    ...
    if checkpoint is not None:
        ...
        if 'dataset_meta' in ckpt.get('meta', {}):
            # checkpoint from mmpose_bboxMasPose 1.x
...
def inference_topdown(model: nn.Module,
    ...
    """
    scope = model.cfg.get('default_scope', 'mmpose_bboxMasPose')
    if scope is not None:
        init_default_scope(scope)
