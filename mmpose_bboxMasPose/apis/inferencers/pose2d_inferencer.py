...
from mmpose_bboxMasPose.evaluation.functional import nearby_joints_nms, nms
from mmpose_bboxMasPose.registry import INFERENCERS
...
class Pose2DInferencer(BaseMMPoseInferencer):
    ...
    Args:
        ...
        scope (str, optional): The scope of the model. Defaults to "mmpose_bboxMasPose".
    ...
    def __init__(self,
                 ...
                 scope: Optional[str] = 'mmpose_bboxMasPose',
    ...
    def update_model_visualizer_settings(self,
        ...
        Args:
            ...
            skeleton_style (str, optional): Skeleton style selection. Valid
                options are 'mmpose_bboxMasPose' and 'openpose'. Defaults to 'mmpose_bboxMasPose'.
        """
        self.model.test_cfg['output_heatmaps'] = draw_heatmap

        if skeleton_style not in ['mmpose_bboxMasPose', 'openpose']:
            raise ValueError('`skeleton_style` must be either \'mmpose_bboxMasPose\' '
                             'or \'openpose\'')
        ...
        if self.cfg.data_mode == 'topdown':
            ...
            if self.detector is not None:
                try:
                    ...
                    print_log(
                        'Support for mmpose_bboxMasPose and mmdet versions up to 3.1.0 '
