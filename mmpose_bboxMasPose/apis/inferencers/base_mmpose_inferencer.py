...
from mmpose_bboxMasPose.apis.inference import dataset_meta_from_config
from mmpose_bboxMasPose.registry import DATASETS
from mmpose_bboxMasPose.structures import PoseDataSample, split_instances
...
class BaseMMPoseInferencer(BaseInferencer):
    ...
    def _init_pipeline(self, cfg: ConfigType) -> Callable:
        ...
        Returns:
            ...
            a single data.
        """
        scope = cfg.get('default_scope', 'mmpose_bboxMasPose')
