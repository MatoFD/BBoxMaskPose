...
with read_base():
    from mmpose_bboxMasPose.configs._base_.default_runtime import *  # noqa
...
from mmpose_bboxMasPose.codecs import EDPoseLabel
from mmpose_bboxMasPose.datasets import (BottomupRandomChoiceResize, BottomupRandomCrop,
                                         CocoDataset, LoadImage, PackPoseInputs,
                                         RandomFlip)
from mmpose_bboxMasPose.evaluation import CocoMetric
from mmpose_bboxMasPose.models import (BottomupPoseEstimator, ChannelMapper, EDPoseHead,
                                       PoseDataPreprocessor, ResNet)
from mmpose_bboxMasPose.models.utils import FrozenBatchNorm2d
