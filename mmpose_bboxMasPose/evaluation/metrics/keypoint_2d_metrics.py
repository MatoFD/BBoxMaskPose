...
class PCKAccuracy(BaseMetric):
    ...
    Examples:
        ...
        >>> from mmpose_bboxMasPose.evaluation.metrics import PCKAccuracy
        >>> import numpy as np
...
class MpiiPCKAccuracy(PCKAccuracy):
    ...
    Examples:
        ...
        >>> from mmpose_bboxMasPose.evaluation.metrics import MpiiPCKAccuracy
        >>> import numpy as np
        >>> from mmengine.structures import InstanceData
        >>> num_keypoints = 16
        >>> keypoints = np.random.random((1, num_keypoints, 2)) * 10
...
class JhmdbPCKAccuracy(PCKAccuracy):
    ...
    Examples:
        ...
        >>> from mmpose_bboxMasPose.evaluation.metrics import JhmdbPCKAccuracy
        >>> import numpy as np
        >>> from mmengine.structures import InstanceData
        >>> num_keypoints = 15
        >>> keypoints = np.random.random((1, num_keypoints, 2)) * 10
