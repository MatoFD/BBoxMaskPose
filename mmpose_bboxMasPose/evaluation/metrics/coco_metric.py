...
from mmpose_bboxMasPose.registry import METRICS
from mmpose_bboxMasPose.structures.bbox import bbox_xyxy2xywh
from mmpose_bboxMasPose.structures.keypoint import find_min_padding_exact, fix_bbox_aspect_ratio
...
class CocoMetric(BaseMetric):
    ...
    def gt_to_coco_json(self, gt_dicts: Sequence[dict],
        ...
        info = dict(
            ...
            description='Coco json file converted by mmpose_bboxMasPose CocoMetric.')
        coco_json = dict(
            info=info,
            images=image_infos,
